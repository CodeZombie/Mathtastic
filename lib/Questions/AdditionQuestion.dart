...
class AdditionQuestion extends StatefulWidget {
  AdditionQuestion({Key key, this.difficulty: 1, this.onCorrect, this.onFalse})
      : super(key: key);
  final Function() onCorrect;
  final Function() onFalse;
  final double difficulty;

  _AdditionQuestionState createState() => _AdditionQuestionState();
}

class _AdditionQuestionState extends State<AdditionQuestion> {
